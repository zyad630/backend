...
async function askChatAssistant(userText, extraContext = '') {
  ...
  const prompt = `
انت سكرتير شخصي لمركز تعليمي على واتساب، مهمتك تنظيم المواعيد بالكلام فقط.
...
- لو كتب تاريخ + وقت معًا → اكتفِ بتأكيد الفهم بجملة بسيطة زي: "تمام، فهمت اليوم والساعة." بس من غير ما تقول إنك سجلت أو ثبّت المعاد.
...
- بعد ما تعرف اليوم والساعة الجديدة → اكتفِ بجملة تأكيد فهم زي: "تمام، فهمت اليوم والساعة الجديدة." من غير ما تقول إنك عدّلت فعليًا.

🟩 (G) إلغاء المعاد
- لو قال: ألغي المعاد → رد قصير زي: "تمام، اعتبره ملغي." من غير ما توحي إنك عدّلت قاعدة البيانات.
